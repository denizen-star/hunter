        ...
        <div id="summary" class="tab-content active">
            ...
            <div class="info-grid">
                <div class="info-card">
                    ...
                    <div class="info-card-value" style="color: #10b981; font-size: 32px;">{contact.match_score:.0f}%</div>
                </div>
                <div class="info-card">
                    <div class="info-card-label">Company</div>
                    <div class="info-card-value">{contact.company_name}</div>
                </div>
                <div class="info-card">
                    <div class="info-card-label">Title</div>
                    <div class="info-card-value">{contact.job_title or 'N/A'}</div>
                </div>
                <div class="info-card">
                    <div class="info-card-label">Status</div>
                    <div class="info-card-value">{contact.status}</div>
                </div>
            </div>
            ...
            <div class="section">
                ...
                <div style="background: #f0fdf4; border-left: 4px solid #10b981; border-radius: 8px; padding: 20px;">
                    <ul style="margin: 0; padding-left: 20px; color: #166534; line-height: 1.8;">
                        <li>Shared background in data engineering and analytics</li>
                        <li>Common experience with cloud platforms and big data</li>
                        <li>Mutual interest in AI/ML applications</li>
                        <li>Similar career progression in technical leadership</li>
                    </ul>
                </div>
            </div>
        </div>
