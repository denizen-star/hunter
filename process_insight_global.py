#!/usr/bin/env python3
"""
Script to process Insight Global application with new structured research format
"""
import os
import sys
...
def process_insight_global():
    """Process Insight Global application with all required sections"""
    
    # Application details
    app_id = "20251014145018-Insight Global-Head of Business Intelligence"
    company = "Insight Global"
    job_title = "Head of Business Intelligence"
    job_url = "https://jobs.insightglobal.com/job/atlanta/head-of-business-intelligence/19/1234567890"
    ...
    try:
        ...
        if application.qualifications_path and Path(application.qualifications_path).exists():
            ...
            print("❌ Qualifications file not found")
            return False
    ...
    print("\n" + "=" * 60)
    print("🎉 Insight Global application processing completed successfully!")
...
if __name__ == "__main__":
    success = process_insight_global()
